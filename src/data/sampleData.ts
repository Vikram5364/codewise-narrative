  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: 'Understanding tree rotation operations for maintaining balance.',
        imageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b',
        duration: 12,
        difficulty: 'Advanced',
        tags: ['trees', 'rotations', 'balancing']
      },
      {
        id: 'btree-applications',
        title: 'B-Tree Applications',
        description: 'Real-world applications of B-trees in databases and file systems.',
        imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6',
        duration: 16,
        difficulty: 'Advanced',
        tags: ['trees', 'b-trees', 'applications']
      },
      {
        id: 'tree-serialization',
        title: 'Tree Serialization',
        description: 'Methods to serialize and deserialize tree structures.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 14,
        difficulty: 'Intermediate',
        tags: ['trees', 'serialization', 'algorithms']
      },
      {
        id: 'tree-path-problems',
        title: 'Tree Path Problems',
        description: 'Solving problems related to paths in trees.',
        imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d',
        duration: 16,
        difficulty: 'Intermediate',
        tags: ['trees', 'paths', 'algorithms']
      },
      {
        id: 'tree-traversal-iterative',
        title: 'Iterative Tree Traversal',
        description: 'Implementing tree traversal algorithms iteratively.',
        imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085',
        duration: 14,
        difficulty: 'Intermediate',
        tags: ['trees', 'traversal', 'iterative']
      },
      {
        id: 'tree-level-order',
        title: 'Level Order Traversal',
        description: 'Breadth-first traversal techniques for trees.',
        imageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b',
        duration: 12,
        difficulty: 'Intermediate',
        tags: ['trees', 'traversal', 'bfs']
      },
      {
        ...
        duration: 15,
        difficulty: 'Advanced',
        tags: ['trees', 'construction', 'algorithms']
      },
      {
        id: 'lowest-common-ancestor',
        title: 'Lowest Common Ancestor',
        description: 'Finding the lowest common ancestor in tree structures.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 13,
        difficulty: 'Intermediate',
        tags: ['trees', 'lca', 'algorithms']
      },
      {
        id: 'expression-trees',
        title: 'Expression Trees',
        description: 'Using trees to represent and evaluate expressions.',
        imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d',
        duration: 15,
        difficulty: 'Intermediate',
        tags: ['trees', 'expressions', 'applications']
      }
    ]
  },
  {
    id: 'graphs',
    title: 'Graphs',
    description: 'Study graph algorithms and their applications.',
    icon: 'network',
    lessons: [
      {
        id: 'graphs-intro',
        title: 'Introduction to Graphs',
        description: 'Learn the basics of graph theory and representation.',
        imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085',
        duration: 12,
        difficulty: 'Intermediate',
      ...
      },
      {
        ...
        description: 'Exploring graphs using breadth-first search.',
        imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6',
        duration: 13,
        difficulty: 'Intermediate',
      ...
      },
      {
        ...
        description: 'Exploring graphs using depth-first search.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 13,
        difficulty: 'Intermediate',
      ...
      },
      {
        ...
        description: 'Finding shortest paths with negative weights.',
        imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085',
        duration: 15,
        difficulty: 'Advanced',
        tags: ['graphs', 'shortest-path', 'algorithms']
      },
      {
        ...
        description: 'Finding minimum spanning trees using Prim\'s algorithm.',
        imageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b',
        duration: 14,
        difficulty: 'Advanced',
      ...
      },
      {
        ...
        description: 'Finding minimum spanning trees using Kruskal\'s algorithm.',
        imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6',
        duration: 14,
        difficulty: 'Advanced',
        tags: ['graphs', 'mst', 'algorithms']
      },
      {
        ...
        description: 'Finding strongly connected components in directed graphs.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 17,
        difficulty: 'Advanced',
        tags: ['graphs', 'scc', 'algorithms']
      },
      {
        id: 'graph-topological-sort',
        title: 'Topological Sorting',
        description: 'Ordering nodes in a directed acyclic graph.',
        imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d',
        duration: 13,
        difficulty: 'Intermediate',
        tags: ['graphs', 'topological-sort', 'algorithms']
      },
      {
        id: 'graph-bipartite',
        title: 'Bipartite Graphs',
        description: 'Understanding and detecting bipartite graphs.',
        imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085',
        duration: 12,
        difficulty: 'Intermediate',
        tags: ['graphs', 'bipartite', 'algorithms']
      },
      {
        id: 'graph-coloring',
        title: 'Graph Coloring',
        description: 'Algorithms for coloring graphs efficiently.',
        imageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b',
        duration: 14,
        difficulty: 'Advanced',
        tags: ['graphs', 'coloring', 'algorithms']
      },
      {
        id: 'graph-flow-networks',
        title: 'Flow Networks',
        description: 'Introduction to flow networks and their applications.',
        imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6',
        duration: 15,
        difficulty: 'Advanced',
        tags: ['graphs', 'flow-networks', 'algorithms']
      },
      {
        id: 'graph-ford-fulkerson',
        title: 'Ford-Fulkerson Algorithm',
        description: 'Finding maximum flow in flow networks.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 16,
        difficulty: 'Advanced',
        tags: ['graphs', 'max-flow', 'algorithms']
      },
      {
        id: 'graph-edmonds-karp',
        title: 'Edmonds-Karp Algorithm',
        description: 'An implementation of Ford-Fulkerson method for maximum flow.',
        imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d',
        duration: 16,
        difficulty: 'Advanced',
        tags: ['graphs', 'max-flow', 'algorithms']
      },
      {
        ...
        description: 'Algorithms for finding matchings in graphs.',
        imageUrl: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085',
        duration: 15,
        difficulty: 'Advanced',
        tags: ['graphs', 'matching', 'algorithms']
      },
      {
        id: 'graph-hamiltonian',
        title: 'Hamiltonian Paths and Cycles',
        description: 'Finding paths and cycles that visit every vertex exactly once.',
        imageUrl: 'https://images.unsplash.com/photo-1488590528505-98d2b5aba04b',
        duration: 13,
        difficulty: 'Advanced',
        tags: ['graphs', 'hamiltonian', 'algorithms']
      },
      {
        id: 'graph-eulerian',
        title: 'Eulerian Paths and Cycles',
        description: 'Finding paths and cycles that use every edge exactly once.',
        imageUrl: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6',
        duration: 14,
        difficulty: 'Advanced',
        tags: ['graphs', 'eulerian', 'algorithms']
      },
      {
        id: 'graph-planarity',
        title: 'Graph Planarity',
        description: 'Testing if a graph can be drawn without edge crossings.',
        imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7',
        duration: 15,
        difficulty: 'Advanced',
        tags: ['graphs', 'planarity', 'algorithms']
      },
      {
        id: 'graph-applications',
        title: 'Real-world Graph Applications',
        description: 'Applications of graph algorithms in various domains.',
        imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d',
        duration: 12,
        difficulty: 'Intermediate',
